...
async def main():
    ...
    generated_image = generate_image(new_positive_prompt, new_negative_prompt, seed=42, save=False)
    ...
    for filename in os.listdir(directory):
        if filename.lower().endswith(('.png', '.jpg', '.jpeg')):
            ...
            for i in range(2):
                ...
                generated_image_path = f"workdir/generated_{filename.split('.')[0]}_{1}_{timestamp}.png"
